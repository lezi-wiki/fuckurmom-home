...
const enUS: TranslationModel = {
    ...
    DetailContext: {
        ...
        "If authenticated, you have unlimited access to subdomains which begin with your name, which is discouraged but considered cool.":
            "If authenticated, you have unlimited access to subdomains which begin with your name, which is discouraged but considered cool.",
        "The application format is as follows:": "The application format is as follows:",
        "Your name": "Your name",
        "Your contact": "Your contact",
        "Your project name": "Your project name",
        "The type of subdomain you are applying for": "The type of subdomain you are applying for",
        "What idiots do (detailed description)": "What idiots do (detailed description)",
        "Idiots' contact": "Idiots' contact",
        "Go for apply": "Go for apply",
        Confirm: "Confirm",
